  ...
  return (
    <section>
      <div className="Container">
        <div className="FlexWrap" style={{alignItems: 'flex-start', gap: '0'}}>
          <GatsbyImage image={image} alt="A welder working" className={`${sty.DetailsImage} ${sty.DetailsImage_default}`}/>
          <TextBox width={644} style={{width: '100%'}}>
            <h2>Our Services</h2>
            <div className={sty.Accordion}>
              <details className={sty.Details1}>
